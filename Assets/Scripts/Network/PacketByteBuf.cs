...
{
    public class PacketByteBuf : Stream
    {
        public Stream _parent { get; set; }
        ...
        public override long Position { get => _parent.Position; set => _parent.Position = value; }

        public PacketByteBuf(Stream parent)
        {
            _parent = parent;
        }

        static PacketByteBuf()
        {
            StringEncoding = Encoding.UTF8;
        }

        public BlockPos readBlockPos() {
            return BlockPos.fromLong(ReadInt16());
        }
